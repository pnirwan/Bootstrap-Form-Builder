...
(function (e, t) {
    ...
    function I(e, t, n) {
        ...
        }, f = u.promise({elem: e, props: ut.extend({}, t), opts: ut.extend(!0, {specialEasing: {}}, n), originalProperties: t, originalOptions: n, startTime: Gn || j(), duration: n.duration, tweens: [], createTween: function (t, n) {
    ...
    ut.fn = ut.prototype = {jquery: Z, constructor: ut, init: function (e, n, r) {
        var i, s;
        if (!e)return this;
        if ("string" == typeof e) {
    ...
    }, push: tt, sort: [].sort, splice: [].splice}, ut.fn.init.prototype = ut.fn, ut.extend = ut.fn.extend = function () {
    ...
    ut.extend({cache: {}, expando: "jQuery" + (Z + Math.random()).replace(/\D/g, ""), noData: {embed: !0, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: !0}, hasData: function (e) {
    ...
    }}), ut.extend({queue: function (e, n, r) {
        var i;
    ...
    ut.fn.extend({attr: function (e, t) {
    ...
    }}, Dt && _t || (ut.attrHooks.value = {get: function (e, n) {
    ...
    }}), _t || (Tt = ut.valHooks.button = {get: function (e, n) {
        var r = e.getAttributeNode(n);
        return r && ("id" === n || "name" === n || "coords" === n ? "" !== r.value : r.specified) ? r.value : t
    }, set: function (e, n, r) {
        var i = e.getAttributeNode(r);
        return i || e.setAttributeNode(i = e.ownerDocument.createAttribute(r)), i.value = n += "", "value" === r || n === e.getAttribute(r) ? n : t
    }}, ut.attrHooks.contenteditable = {get: Tt.get, set: function (e, t, n) {
        Tt.set(e, "" === t ? !1 : t, n)
    }}, ut.each(["width", "height"], function (e, n) {
        ut.attrHooks[n] = ut.extend(ut.attrHooks[n], {set: function (e, r) {
        ...
        ut.valHooks[this] = ut.extend(ut.valHooks[this], {set: function (e, n) {
    ...
    ut.event = {global: {}, add: function (e, n, r, i, s) {
    ...
    }, ut.Event.prototype = {isDefaultPrevented: f, isPropagationStopped: f, isImmediatePropagationStopped: f, preventDefault: function () {
    ...
    }), ut.fn.extend({on: function (e, n, r, i, s) {
        var o, u;
        if ("object" == typeof e) {
        ...
        C = o.isXML = function (e) {
            ...
            return n
        }, T = o.selectors = {cacheLength: 50, createPseudo: i, match: ht, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (e) {
    ...
    var It = /Until$/, qt = /^(?:parents|prev(?:Until|All))/, Rt = /^.[^:#\[\.,]*$/, Ut = ut.expr.match.needsContext, zt = {children: !0, contents: !0, next: !0, prev: !0};
    ...
    sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ut.fn.extend({text: function (e) {
        ...
        if (c && (i = ut.buildFragment(e, this[0].ownerDocument, !1, this), s = i.firstChild, 1 === i.childNodes.length && (i = s), s)) {
            ...
            if (u)for (f = o[o.length - 1].ownerDocument, ut.map(o, v), l = 0; u > l; l++)a = o[l], tn.test(a.type || "") && !ut._data(a, "globalEval") && ut.contains(f, a) && (a.src ? ut.ajax({url: a.src, type: "GET", dataType: "script", async: !1, global: !1, "throws": !0}) : ut.globalEval((a.text || a.textContent || a.innerHTML || "").replace(rn, "")));
            i = s = null
        }
        return this
    ...
    var an, fn, ln, cn = /alpha\([^)]*\)/i, hn = /opacity\s*=\s*([^)]*)/, pn = /^(top|right|bottom|left)$/, dn = /^(none|table(?!-c[ea]).+)/, vn = /^margin/, mn = RegExp("^(" + at + ")(.*)$", "i"), gn = RegExp("^(" + at + ")(?!px)[a-z%]+$", "i"), yn = RegExp("^([+-])=(" + at + ")", "i"), bn = {BODY: "block"}, wn = {position: "absolute", visibility: "hidden", display: "block"}, En = {letterSpacing: 0, fontWeight: 400}, Sn = ["Top", "Right", "Bottom", "Left"], xn = ["Webkit", "O", "Moz", "ms"];
    ut.fn.extend({css: function (e, n) {
        ...
        ut.cssHooks[n] = {get: function (e, r, i) {
        ...
        ut.support.reliableMarginRight || (ut.cssHooks.marginRight = {get: function (e, n) {
            ...
            ut.cssHooks[n] = {get: function (e, r) {
    ...
    An = In.exec(On.toLowerCase()) || [], ut.fn.load = function (e, n, r) {
        ...
        return a >= 0 && (i = e.slice(a, e.length), e = e.slice(0, a)), ut.isFunction(n) ? (r = n, n = t) : n && "object" == typeof n && (s = "POST"), u.length > 0 && ut.ajax({url: e, type: s, dataType: "html", data: n}).done(function (e) {
        ...
        ut[n] = function (e, r, i, s) {
            return ut.isFunction(r) && (s = s || i, i = r, r = t), ut.ajax({url: e, type: n, dataType: s, data: r, success: i})
        }
    ...
    }, ajaxPrefilter: O(Rn), ajaxTransport: O(Un), ajax: function (e, n) {
        function r(e, n, r, u) {
            var f, c, y, b, E, x = n;
        ...
        var i, s, o, u, a, f, l, c, h = ut.ajaxSetup({}, n), p = h.context || h, d = h.context && (p.nodeType || p.jquery) ? ut(p) : ut.event, v = ut.Deferred(), m = ut.Callbacks("once memory"), g = h.statusCode || {}, y = {}, b = {}, w = 0, E = "canceled", S = {readyState: 0, getResponseHeader: function (e) {
            var t;
            if (2 === w) {
    ...
    var Gn, Yn, Zn = /^(?:toggle|show|hide)$/, er = RegExp("^(?:([+-])=|)(" + at + ")([a-z%]*)$", "i"), tr = /queueHooks$/, nr = [R], rr = {"*": [function (e, t) {
    ...
    ut.Animation = ut.extend(I, {tweener: function (e, t) {
        ut.isFunction(e) ? (t = e, e = ["*"]) : e = e.split(" ");
        for (var n, r = 0, i = e.length; i > r; r++)n = e[r], rr[n] = rr[n] || [], rr[n].unshift(t)
    }, prefilter: function (e, t) {
        t ? nr.unshift(e) : nr.push(e)
    }}), ut.Tween = U, U.prototype = {constructor: U, init: function (e, t, n, r, i, s) {
    ...
    return n.Model.extend({getValues: function () {
    ...
    return n.View.extend({tagName: "div", className: "component", initialize: function () {
        this.template = t.template(f[this.model.idFriendlyTitle()]), this.popoverTemplates = {input: t.template(i), select: t.template(s), textarea: t.template(o), "textarea-split": t.template(u), checkbox: t.template(a)}
    }, render: function (e) {
        var n = this, i = t.template(r)({title: n.model.get("title"), items: n.model.get("fields"), popoverTemplates: n.popoverTemplates});
    ...
    return t.extend({initialize: function () {
    ...
    return i.extend({events: {mousedown: "mouseDownHandler"}, mouseDownHandler: function (t) {
    ...
    return n.Collection.extend({model: r, renderAll: function () {
    ...
    return r.extend({events: {click: "preventPropagation", mousedown: "mouseDownHandler", mouseup: "mouseUpHandler"}, mouseDownHandler: function (t) {
    ...
    return i.extend({model: r, renderAll: function () {
        return this.map(function (e) {
    ...
    return n.View.extend({tagName: "div", className: "tab-pane", initialize: function () {
        ...
        n.collection !== undefined ? t.each(this.collection.renderAll(), function (e) {
            n.$el.append(e)
        }) : n.options.content && n.$el.append(n.options.content), e("#formtabs").append(this.tabNavTemplate({title: this.options.title, id: this.id})), this.$el.attr("id", this.id), this.$el.appendTo(".tab-content"), this.delegateEvents()
    }})
    ...
    return n.View.extend({tagName: "fieldset", initialize: function () {
        ...
        t.each(this.collection.renderAll(), function (e) {
            n.$el.append(e)
        }), e("#render").val(n.renderForm({text: t.map(this.collection.renderAllClean(),function (e) {
            return e.html()
    ...
    return{initialize: function () {
        new s({title: "Input", collection: new r(JSON.parse(u))}), new s({title: "Radios / Checkboxes", collection: new r(JSON.parse(a))}), new s({title: "Select", collection: new r(JSON.parse(f))}), new s({title: "Buttons", collection: new r(JSON.parse(l))}), new s({title: "Rendered", content: c}), new s({title: "Json", content: c}), new s({title: "About", content: h}), e("#components .tab-pane").first().addClass("active"), e("#formtabs li").first().addClass("active"), new o({title: "Original", collection: new i([
            {title: "Form Name", fields: {name: {label: "Form Name", type: "input", value: "Form Name"}}}
        ])})
    }}
}), require.config({baseUrl: "assets/js/lib/", shim: {backbone: {deps: ["underscore", "jquery"], exports: "Backbone"}, underscore: {exports: "_"}, bootstrap: {deps: ["jquery"], exports: "$.fn.popover"}}, paths: {app: "..", collections: "../collections", data: "../data", models: "../models", helper: "../helper", templates: "../templates", views: "../views"}}), require(["app/app"], function (e) {
    e.initialize()
